...
**Project**: cheerful-confetti-explosion 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: A cheerful confetti app 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/cheerful-confetti-explosion.git
cd cheerful-confetti-explosion
npm i
